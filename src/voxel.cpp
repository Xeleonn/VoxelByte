...
Voxel::Chunk Voxel::GenerateTestChunk()
{
    ...
    for (int x = 0; x < CHUNK_SIZE; x++)
    {
        for (int y = 0; y < CHUNK_SIZE; y++)
        {
            ...
            {
                VoxelData vd;
                if (y % 3 == 0) vd = {0, VoxelProperties::VoxelFlagSolid, 15};
                else vd = {0, VoxelProperties::VoxelFlagNull, 15};
...
Voxel::OpenGLMesh Voxel::GenerateChunkMesh(Chunk chunk)
{
    ...
    for (int x = 0; x < CHUNK_SIZE; x++)
    {
        for (int y = 0; y < CHUNK_SIZE; y++)
        {
            for (int z = 0; z < CHUNK_SIZE; z++)
            {
                if (chunk.voxel_grid[x][y][z].properties & VoxelProperties::VoxelFlagSolid != VoxelProperties::VoxelFlagNull)
                {
                    // add triangles to top
                    if ((y + 1  == CHUNK_SIZE) || (chunk.voxel_grid[x][y + 1][z].properties & VoxelProperties::VoxelFlagSolid) == VoxelProperties::VoxelFlagNull)
                    {
                    ...
                    if ((y == 0) || (chunk.voxel_grid[x][y - 1][z].properties & VoxelProperties::VoxelFlagSolid) == VoxelProperties::VoxelFlagNull)
                    {
                    ...
                    if ((x + 1 == CHUNK_SIZE) || (chunk.voxel_grid[x + 1][y][z].properties & VoxelProperties::VoxelFlagSolid) == VoxelProperties::VoxelFlagNull)
                    {
                    ...
                    if ((x == 0) || (chunk.voxel_grid[x - 1][y][z].properties & VoxelProperties::VoxelFlagSolid) == VoxelProperties::VoxelFlagNull)
                    {
                        int v0 = chunk_mesh.AddVertex((float)x, (float)y, (float)z);
                    ...
                    if ((z + 1 == CHUNK_SIZE) || (chunk.voxel_grid[x][y][z + 1].properties & VoxelProperties::VoxelFlagSolid) == VoxelProperties::VoxelFlagNull)
                    {
                    ...
                    if ((z == 0) || (chunk.voxel_grid[x][y][z - 1].properties & VoxelProperties::VoxelFlagSolid) == VoxelProperties::VoxelFlagNull)
                    {
                        int v0 = chunk_mesh.AddVertex((float)x, (float)y, (float)z);
                        int v1 = chunk_mesh.AddVertex((float)x + 1, (float)y, (float)z);
